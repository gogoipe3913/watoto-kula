  ...
  <div className={style.BarConcepts}>
    <div className={style.BarConcepts__contents}>
      ...
      <ul className={style.BarConcepts__contentTexts}>
        <li>
          <h3 className={style.BarConcepts__contentTitle}>Cocktail</h3>
          ...
          <p className={style.BarConcepts__contentTextBodyEn}>
            ...
            based on "Nijūshi Sekki Shichijūni Kō" (Twenty-four Solar Terms and
            Seventy-two Microseasons) - a traditional calendar that divides the
            year into detailed seasonal periods. Please enjoy our special
            cocktails that embrace the subtle changes of seasons and capture the
            essence of Fukui's terroir and seasonal fragrances.
          </p>
        </li>
        <li>
          <h3 className={style.BarConcepts__contentTitle}>Coffee</h3>
          <p className={style.BarConcepts__contentTextBodyJa}>
          ...
          <p className={style.BarConcepts__contentTextBodyEn}>
            ...
            information. Coffee is also available during bar hours. Please enjoy
            spending time at your own pace, in your own way.
          </p>
        </li>
        <li>
          <h3 className={style.BarConcepts__contentTitle}>Lunch</h3>
          <p className={style.BarConcepts__contentTextBodyJa}>
          ...
          <p className={style.BarConcepts__contentTextBodyEn}>
            At watoto, we serve dishes incorporating Chinese herbal cuisine and
            fermented foods, primarily featuring seasonal ingredients from Fukui
            Prefecture. Our ingredients are selected based on the Twenty-four
            Solar Terms, focusing on seasonal plants to create dishes that
            maximize nature's inherent properties. While our approach is
            inspired by Buddhist shōjin cuisine principles, we aim to provide a
            relaxed dining experience without any formality - a place where you
            can truly unwind. Please enjoy our casual yet nourishing cuisine
            that gently harmonizes both mind and body.
          </p>
        </li>
      </ul>
    </div>
